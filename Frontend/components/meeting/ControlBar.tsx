              ...
              {props.isHost ? (
                <div className="flex flex-col gap-3">
                  ...
                  <motion.button
                    ...
                    className="w-full bg-[#1C1C2B] border border-[#2B2B2B] hover:bg-[#252538] hover:border-[#3D3D58] text-white py-3 rounded-2xl text-sm font-semibold transition font-sora"
                  >
                    Just Leave Meeting
                  </motion.button>
                  <button
